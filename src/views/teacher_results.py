...
import pandas as pd
from src.views.admin_results import generate_report_card, get_pdf_preview, generate_class_bulk_report, get_available_fonts
                ...
                if st.button("⚙️ Generate Bulk Report Cards", type="primary", key="btn_gen_bulk_t"):
                    with st.status("Generating Bulk Report Cards...", expanded=True) as status:
                        try:
                            ...
                            pdf_buffer = generate_class_bulk_report(students, selected_class_data, bulk_teacher_name, target_fontname_b, sel_size_b, sel_color_b)
